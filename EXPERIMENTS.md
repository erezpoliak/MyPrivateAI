...
|---|---|---|---|---|---|---|---|
| 1 | **Closed Book** | N/A | None | None | Llama 3.1 8B | GPT-4.1-mini | Reference floor (no targets) |
| 2 | **Baseline** | Fixed 512 | Vector k=5 | None | Llama 3.1 8B | GPT-4.1-mini | AC > Closed Book |
| 3 | **Phase 1** | Semantic | Hybrid BM25+Vector (RRF) | FlashRank top-3 | Llama 3.1 8B | GPT-4.1-mini | CR > 0.92, Faith > 0.98 |
| 4 | **Phase 2** | Semantic | Multi-hop agent using Hybrid BM25+Vector (RRF) | FlashRank top-3 | Llama 3.1 8B | GPT-4.1-mini | AC > 85% ceiling, Traj > 0.80, AC(cplx 3-4) ≥ Llama+Gold_REF |
| 5 | **Llama+Gold_REF** | N/A | Gold_REF injected | None | Llama 3.1 8B | GPT-4.1-mini | Llama comprehension ceiling |
...
> An Optimized Agentic RAG pipeline can compensate for an 8B model's limitations and achieve performance close to GPT-4o on complex private document tasks.
