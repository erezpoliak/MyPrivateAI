...
|---|---|---|---|---|---|---|---|
| 1 | **Closed Book** | N/A | None | None | Llama 3.1 8B | GPT-4o-mini | Reference floor (no targets) |
| 2 | **Baseline** | Fixed 512 | Vector k=5 | None | Llama 3.1 8B | GPT-4o-mini | AC > Closed Book |
