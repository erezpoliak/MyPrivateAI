...
| 4 | **Phase 2** | Semantic | Multi-hop agent using Hybrid BM25+Vector (RRF) | FlashRank top-3 | Yes | Llama 3.1 8B | GPT-4.1-mini | AC > 85% ceiling, Traj > 0.80, AC(cplx 3-4) ≥ Llama+Gold_REF |
| 5 | **Llama+Gold_REF** | N/A | Gold_REF injected | None | No | Llama 3.1 8B | GPT-4.1-mini | Llama comprehension ceiling |
| 6 | **GPT-4o RAG (Ceiling)** | Semantic | Multi-hop agent using Hybrid BM25+Vector (RRF) | FlashRank top-3 | Yes | GPT-4o | GPT-4.1-mini | Upper bound anchor — identical pipeline to Phase 2, only LLM differs |
