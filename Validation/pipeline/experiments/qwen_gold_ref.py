"""Qwen+Gold-REF experiment — Gold_REF as sole context, Qwen3.5 9B.

Injects each question's Gold_REF text as the only context and sends it to
Qwen3.5 9B via mlx-lm.  GPT-4.1-mini as RAGAS judge.  All RAGAS metrics
...
def main() -> None:
    args = parse_args(
        description="Qwen+Gold-REF experiment: Gold_REF as sole context, Qwen3.5 9B.",
